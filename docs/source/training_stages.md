...
## Senior Robotics Rule

Treat deployment telemetry as its own data product. It is not just "more
demonstrations"; it can train world models, reward/progress heads, filters, and
failure miners.
